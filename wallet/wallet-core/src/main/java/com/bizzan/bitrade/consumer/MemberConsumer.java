...
public class MemberConsumer {
     ...
     * @param record
     */
    @KafkaListener(topics = {"reset-member-address"}, containerFactory = "kafkaListenerContainerFactory")
    public void resetAddress(ConsumerRecord<String, String> record, Acknowledgment ack) throws Exception {
        try {
     ...
     * @param content
     */
    @KafkaListener(topics = {"member-register"}, containerFactory = "kafkaListenerContainerFactory")
    public void handle(String content, Acknowledgment ack) throws Exception {
