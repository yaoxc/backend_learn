...
public class ActivityController  extends BaseController {
     ...
     * 短信/邮箱验证码校验（防刷）
     * 实名+交易权限+活动时间窗+总硬顶校验
     * 个人“已参与额度/次数”聚合查询（悲观限仓）
     * 持仓门槛检查（HoldLimit）——必须持有指定币种≥X 个才能入场
     * 余额充足检查——根据活动类型计算需要冻结/扣除的币种数量
     * 生成 ActivityOrder，调用 activityOrderService.saveActivityOrder(…) 落库+冻结（同一事务）
     */
