...
public class DataDictionarySaveUpdateConsumer {
    ...
    @KafkaListener(topics = "data-dictionary-save-update", 
    containerFactory = "kafkaListenerContainerFactory",
    groupId = "market-handle-data-dictionary-save-update-group")
    public void handelDataDictionarySaveUpdate(List<ConsumerRecord<String,String>> records, Acknowledgment ack) throws Exception {
        try {
